...
def parameter_set(opt):
    ...
    opt.checkpoints_dir = "/content/drive/MyDrive/hybrid_project/modules/Bringing_Old_Photos_Back_to_Life/global_checkpoints/restoration"
    ##
...
if __name__ == "__main__":
    ...
    for i in range(dataset_size):
        ...
        if input_name.endswith(('.jpg', '.JPG', '.jpeg', '.JPEG', '.png', '.PNG')):
